...
make clean
for opts in \
    " -DLINESCAN=1 -DLOWRES=1 -DFAST_SWEEP=1 -DLOWRES_BITS=3" \
    " -DLINESCAN=0 -DLOWRES=1 -DFAST_SWEEP=1 -DLOWRES_BITS=3" \
    " -DLINESCAN=1 -DLOWRES=1 -DFAST_SWEEP=1 -DLOWRES_BITS=4" \
    " -DLINESCAN=0 -DLOWRES=1 -DFAST_SWEEP=1 -DLOWRES_BITS=4" \
    " -DLINESCAN=1 -DLOWRES=0 -DFAST_SWEEP=1                " \
